...
Private repositories can gate CI with the Pro license:
...
The GitHub Action exposes the same check through `license-endpoint`, `license-key`, and `license-email` inputs.
...
- [MCP Audit Starter Kit](docs/starter-kit/README.md)
